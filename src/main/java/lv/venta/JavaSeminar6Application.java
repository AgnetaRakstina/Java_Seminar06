...
public class JavaSeminar6Application {
	...
	@Bean // automatiski izpildis so funckiju startejot sistemu
	public CommandLineRunner testRepo(IStudentRepo studRepo, IProfessorRepo profRepo,
		...
		return new CommandLineRunner() {
			...
			public void run(String... args) throws Exception {
				...
				Grade gr1 = new Grade(10, stud1, course1);
				Grade gr2 = new Grade(7, stud1, course2);
				
				Grade gr3 = new Grade(4, stud2, course1);
				Grade gr4 = new Grade(5, stud2, course2);
